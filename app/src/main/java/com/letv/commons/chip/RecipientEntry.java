...
public class RecipientEntry {
    ...
    public String toAll() {
        return "mEntryType: " + mEntryType + ", mIsFirstLevel: " + mIsFirstLevel + ", mDisplayName: " + mDisplayName
                 + ", mDestination: " + mDestination + ", mDestinationType: " + mDestinationType + ", mDestinationLabel: " + mDestinationLabel
                 + ", mContactId" + mContactId + ", mDirectoryId: " + mDirectoryId + ", mDataId: " + mDataId + ", mPhotoThumbnailUri: " + mPhotoThumbnailUri
                 + ", mIsValid: " + mIsValid + ", mLookupKey: " + mLookupKey;
    }
     ...
     */
    private static String pickDisplayName(String lookupKey, String displayName,
            String destination) {
        return /*(lookupKey == null) ? displayName : */destination;
    }
    ...
    public static RecipientEntry constructTopLevelEntry(String displayName, int displayNameSource,
                                                        String destination, int destinationType,
                                                        String destinationLabel, long contactId,
                                                        Long directoryId, long dataId,
                                                        Uri photoThumbnailUri, boolean isValid,
                                                        String lookupKey) {
        return new RecipientEntry(ENTRY_TYPE_PERSON, pickDisplayName(lookupKey,
